...
## Overview
 ----------------------------------------------------------------------------------------------------
This project is an intention recognition model created using SpaCy and scikit-learn. It provides a useful tool for users to identify intentions from input data. Currently the pipeline incorporates a single SVM model utilizing tfidf data. The pipeline can be extended to incorporate other models and data as needed. Currently classification results are simply printed to the console however in a production environment the ClassificationHandler class of the main.py module can be modified to incorporate output results such as API calls.
...
## Installation 
----------------------------------------------------------------------------------------------------
To set up the model simply store the main.py module, fitted_model.txt, and spacy_nlp.txt in the same directory. For ease of use in customizing the preprocessing and model training components of the pipeline, both the .py and .ipynb files are included in the project directory. Additionally, the Bittext data set has been included in the project files.
...
Additionally, install the spaCy language model required some modules for this project. You can use the following command:
...
- `model_training`: Implements the intention recognition model using SpaCy and scikit-learn Currently incorporates tfidf with a linear SVM model for classification.
